(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(route, router, _loginService) {
                    this.route = route;
                    this.router = router;
                ...
                HomeComponent.prototype.goToUserHome = function () {
                ...
                HomeComponent.prototype.onSubmit = function () {
                    ...
                    this._loginService.loginfunciton(this.loginModel)
                        .subscribe(function (data) { return console.log('Success!', data); }, function (error) { return _this.errorMsg = error.statusText; });
                    this.goToUserHome();
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginService = /** @class */ (function () {
                ...
                LoginService.prototype.loginfunciton = function (login) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileComponent = /** @class */ (function () {
                function ProfileComponent(fb, _updateProfileService) {
                    this.fb = fb;
                ...
                ProfileComponent.prototype.onSubmit = function () {
                    ...
                    this._updateProfileService.update(this.updateProfileForm.value)
                        .subscribe(function (response) { return console.log('Success!', response); }, function (error) { return console.log('Error!', error); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UpdateProfileService = /** @class */ (function () {
                ...
                UpdateProfileService.prototype.update = function (userData) {
                    return this._http.post(this._url, userData);
                };
                return UpdateProfileService;
            }());
            UpdateProfileService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserHomeComponent = /** @class */ (function () {
                function UserHomeComponent(route, router) {
                    this.route = route;
                    this.router = router;
                }
                UserHomeComponent.prototype.ngOnInit = function () {
                };
                UserHomeComponent.prototype.gotoPrescriptions = function () {
                    //this.router.navigate(['prescriptions'],{relativeTo: this.route});
                    this.router.navigate(['prescriptions']);
                };
                UserHomeComponent.prototype.gotoDocuments = function () {
                    //this.router.navigate(['documents'],{relativeTo: this.route});
                    this.router.navigate(['documents']);
                };
                UserHomeComponent.prototype.gotoDoctors = function () {
                    //this.router.navigate(['doctors'],{relativeTo: this.route});
                    this.router.navigate(['doctors']);
                };
                UserHomeComponent.prototype.gotoHospitals = function () {
                    //this.router.navigate(['hospitals'],{relativeTo: this.route});
                    this.router.navigate(['hospitals']);
                };
                UserHomeComponent.prototype.gotoProfile = function () {
